...
//            if(OnIsland.checkOnIsland(enemy,this)){
...
//            }
    ...
    public void setupEnemies() {
        ...
        //enemies.add(new Enemy(new Vector2D(this.position.x + this.width/2 - amountDistance/2, this.position.y - random.nextInt(100) - 100)));
